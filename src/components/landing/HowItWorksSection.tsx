...
const steps = [
  {
    ...
    description: "Upload your company knowledge docs and Excel lead sheet with phone numbers.",
  },
  {
    icon: Cpu,
    step: "02",
    title: "Train Your AI Agent",
    description: "The AI learns your products, services, and talking points from your documents.",
  },
  {
    icon: PhoneCall,
    step: "03",
    title: "Launch Campaigns",
    description: "Start your campaign and let the AI call, qualify, and report back on every lead.",
  },
];
    ...
    <section id="how-it-works" className="py-32 relative">
      <div className="container mx-auto px-6">
        <div className="text-center space-y-4 mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-bold">Three steps to automated outreach</h2>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {steps.map((s, i) => (
            <div key={s.step} className="relative text-center space-y-6">
              ...
              <div className="w-24 h-24 rounded-2xl gradient-primary mx-auto flex items-center justify-center shadow-lg">
