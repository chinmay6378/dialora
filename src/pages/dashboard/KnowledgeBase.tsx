  ...
  return (
    <div className="space-y-6 max-w-6xl">
      ...
      <div className="p-12 rounded-2xl border-2 border-dashed border-border/50 hover:border-primary/50 transition-colors text-center space-y-4 cursor-pointer group glass-card">
        ...
        <div>
          <p className="font-semibold text-lg text-foreground">Upload knowledge documents</p>
      ...
      <div className="space-y-3">
        {docs.map((doc) => (
          <div key={doc.name} className="flex items-center justify-between p-5 rounded-2xl glass-card">
